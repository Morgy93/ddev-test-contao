...
class getContao_Security_DataContainer_ArticleContentVoterService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['contao.security.data_container.article_content_voter'] = new \Contao\CoreBundle\Security\Voter\DataContainer\ArticleContentVoter(($container->services['contao.framework'] ?? self::getContao_FrameworkService($container)), $a);
    }
}
