...
class getMessenger_Transport_ContaoPrioLowService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.transport.contao_prio_low'] = $a->createTransport('contao-auto-fallback://contao_prio_low?target=contao_prio_low_doctrine&fallback=sync', ['transport_name' => 'contao_prio_low'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
