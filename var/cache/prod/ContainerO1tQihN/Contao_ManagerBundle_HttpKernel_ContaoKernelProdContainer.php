...
class Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer extends Container
{
    ...
    protected static function getAssets_PackagesService($container)
    {
        ...
        $e = new \Symfony\Component\Asset\PathPackage('assets/ace', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.33.0', '%s?v=%s'), $d);
        $f = new \Symfony\Component\Asset\PathPackage('assets/chosen', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('2.0.2', '%s?v=%s'), $d);
        $g = new \Symfony\Component\Asset\PathPackage('assets/colorbox', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.6.6', '%s?v=%s'), $d);
        $h = new \Symfony\Component\Asset\PathPackage('assets/colorpicker', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.5.3', '%s?v=%s'), $d);
        $i = new \Symfony\Component\Asset\PathPackage('assets/contao', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('9.3.5', '%s?v=%s'), $d);
        $j = new \Symfony\Component\Asset\PathPackage('assets/datepicker', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('3.0.0', '%s?v=%s'), $d);
        $k = new \Symfony\Component\Asset\PathPackage('assets/dropzone', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('5.9.3', '%s?v=%s'), $d);
        $l = new \Symfony\Component\Asset\PathPackage('assets/handorgel', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.0.0.1', '%s?v=%s'), $d);
        $m = new \Symfony\Component\Asset\PathPackage('assets/jquery', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('3.7.1', '%s?v=%s'), $d);
        $n = new \Symfony\Component\Asset\PathPackage('assets/jquery-ui', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.13.2', '%s?v=%s'), $d);
        $o = new \Symfony\Component\Asset\PathPackage('assets/mediabox', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.5.5', '%s?v=%s'), $d);
        $p = new \Symfony\Component\Asset\PathPackage('assets/mootools', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.6.0.7', '%s?v=%s'), $d);
        $q = new \Symfony\Component\Asset\PathPackage('assets/simplemodal', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('3.0.1', '%s?v=%s'), $d);
        $r = new \Symfony\Component\Asset\PathPackage('assets/swipe', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('2.2.1', '%s?v=%s'), $d);
        $s = new \Symfony\Component\Asset\PathPackage('assets/swiper', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('11.0.6.1', '%s?v=%s'), $d);
        $t = new \Symfony\Component\Asset\PathPackage('assets/tablesort', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('4.0.1', '%s?v=%s'), $d);
        $u = new \Symfony\Component\Asset\PathPackage('assets/tablesorter', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('2.31.3', '%s?v=%s'), $d);
        $v = new \Symfony\Component\Asset\PathPackage('assets/tinymce4', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('6.8.3.1', '%s?v=%s'), $d);
        $w = new \Symfony\Component\Asset\PathPackage('assets/tristen-tablesort', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('5.3.1', '%s?v=%s'), $d);
        ...
        $instance->addPackage('contao-components/chosen', $f);
        $instance->addPackage('contao-components/colorbox', $g);
        $instance->addPackage('contao-components/colorpicker', $h);
        $instance->addPackage('contao-components/contao', $i);
        $instance->addPackage('contao-components/datepicker', $j);
        $instance->addPackage('contao-components/dropzone', $k);
        $instance->addPackage('contao-components/handorgel', $l);
        $instance->addPackage('contao-components/jquery', $m);
        $instance->addPackage('contao-components/jquery-ui', $n);
        $instance->addPackage('contao-components/mediabox', $o);
        $instance->addPackage('contao-components/mootools', $p);
        $instance->addPackage('contao-components/simplemodal', $q);
        $instance->addPackage('contao-components/swipe', $r);
        $instance->addPackage('contao-components/swiper', $s);
        $instance->addPackage('contao-components/tablesort', $t);
        $instance->addPackage('contao-components/tablesorter', $u);
        $instance->addPackage('contao-components/tinymce4', $v);
        $instance->addPackage('contao-components/tristen-tablesort', $w);
        $instance->addPackage('contao-components/ace', $e);
        $instance->addPackage('contao-components/chosen', $f);
        $instance->addPackage('contao-components/colorbox', $g);
        $instance->addPackage('contao-components/colorpicker', $h);
    ...
    {
        return $container->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pkz7juOAiH', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getContao_FrameworkService($container)
    {
        ...
        $instance->setHookListeners(['getSystemMessages' => [[['contao.listener.administrator_email', '__invoke']]], 'loadDataContainer' => [200 => [['contao.listener.data_container.default_global_operations', '__invoke'], ['contao.listener.data_container.default_operations', '__invoke'], ['contao.listener.data_container.enum_options', '__invoke']], 0 => [['contao.listener.data_container.preview_link', 'unloadTableWithoutPreviewScript'], ['contao.listener.data_container.record_preview', 'registerDeleteCallbacks'], ['contao_comments.listener.data_container.add_comment_fields', '__invoke']], -16 => [['contao.listener.data_container_callback', 'onLoadDataContainer']]], 'initializeSystem' => [255 => [['contao.listener.kor5vFl', 'onInitializeSystem'], ['contao.listener.P51ceSn', 'onInitializeSystem']], 0 => [['contao.listener.data_container.preview_link', 'unloadModuleWithoutPreviewScript']]], 'replaceInsertTags' => [[['contao.listener.insert_tags.asset', 'onReplaceInsertTags'], ['contao.listener.insert_tags.date', '__invoke'], ['contao.listener.insert_tags.translation', 'onReplaceInsertTags'], ['contao_faq.listener.insert_tags', 'onReplaceInsertTags'], ['contao_news.listener.insert_tags', '__invoke'], ['contao_calendar.listener.insert_tags', '__invoke']]], 'addCustomRegexp' => [[['contao.listener.widget.custom_rgxp', '__invoke'], ['contao.listener.widget.http_url', '__invoke']]], 'getPageStatusIcon' => [[['contao_news.listener.data_container.page', 'getStatusIcon']]], 'generatePage' => [[['contao_news.listener.generate_page', '__invoke'], ['contao_calendar.listener.generate_page', '__invoke']]]]);
    ...
    protected static function getContao_Twig_FilesystemLoaderService($container)
    {
        ...
        return $container->services['contao.twig.filesystem_loader'] = new \Contao\CoreBundle\Twig\Loader\ContaoFilesystemLoader(($container->services['cache.system'] ?? self::getCache_SystemService($container)), new \Contao\CoreBundle\Twig\Loader\TemplateLocator(\dirname(__DIR__, 4), $container->parameters['kernel.bundles'], $container->parameters['kernel.bundles_metadata'], $b, $a), $b, ($container->services['contao.framework'] ?? self::getContao_FrameworkService($container)), \dirname(__DIR__, 4));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.response', [#[\Closure(name: 'contao.listener.make_response_private', class: 'Contao\\CoreBundle\\EventListener\\MakeResponsePrivateListener')] fn () => ($container->privates['contao.listener.make_response_private'] ?? self::getContao_Listener_MakeResponsePrivateService($container)), '__invoke'], -896);
        ...
        $instance->addListener('Symfony\\Component\\Messenger\\Event\\WorkerRunningEvent', [#[\Closure(name: 'contao.messenger.worker_listener', class: 'Contao\\CoreBundle\\Messenger\\EventListener\\WorkerListener')] fn () => ($container->privates['contao.messenger.worker_listener'] ?? $container->load('getContao_Messenger_WorkerListenerService')), 'onWorkerRunning'], 0);
        $instance->addListener('Symfony\\Component\\Messenger\\Event\\WorkerStartedEvent', [#[\Closure(name: 'contao.messenger.worker_listener', class: 'Contao\\CoreBundle\\Messenger\\EventListener\\WorkerListener')] fn () => ($container->privates['contao.messenger.worker_listener'] ?? $container->load('getContao_Messenger_WorkerListenerService')), 'onWorkerStarted'], 0);
        ...
        $instance->addListener('kernel.response', [#[\Closure(name: 'contao.listener.csrf_token_cookie', class: 'Contao\\CoreBundle\\EventListener\\CsrfTokenCookieSubscriber')] fn () => ($container->privates['contao.listener.csrf_token_cookie'] ?? self::getContao_Listener_CsrfTokenCookieService($container)), 'onKernelResponse'], -832);
    ...
    {
        return $container->privates['contao.monolog.handler'] = new \Contao\CoreBundle\Monolog\ContaoTableHandler(#[\Closure(name: 'doctrine.dbal.default_connection', class: 'Doctrine\\DBAL\\Connection')] fn () => ($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'debug', false);
    }
    ...
    {
        $container->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('OAIW5C3eZI', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, false)));
    ...
    {
        return $container->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L81utmcPn6', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getSecurity_Access_DecisionManagerService($container)
    {
        ...
        return $container->privates['security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 8 => ($container->privates['contao.security.data_container.favorites_voter'] ??= new \Contao\CoreBundle\Security\Voter\DataContainer\FavoritesVoter());
            yield 9 => ($container->privates['contao.security.data_container.form_access_voter'] ?? $container->load('getContao_Security_DataContainer_FormAccessVoterService'));
            yield 10 => ($container->privates['contao.security.data_container.form_field_access_voter'] ?? $container->load('getContao_Security_DataContainer_FormFieldAccessVoterService'));
            yield 11 => ($container->privates['contao.security.data_container.frontend_module_voter'] ?? $container->load('getContao_Security_DataContainer_FrontendModuleVoterService'));
            yield 12 => ($container->privates['contao.security.data_container.image_size_access_voter'] ?? $container->load('getContao_Security_DataContainer_ImageSizeAccessVoterService'));
            yield 13 => ($container->privates['contao.security.data_container.image_size_item_access_voter'] ?? $container->load('getContao_Security_DataContainer_ImageSizeItemAccessVoterService'));
            yield 14 => ($container->privates['contao.security.data_container.layout_access_voter'] ?? $container->load('getContao_Security_DataContainer_LayoutAccessVoterService'));
            yield 15 => ($container->privates['contao.security.data_container.page_permission_voter'] ?? $container->load('getContao_Security_DataContainer_PagePermissionVoterService'));
            yield 16 => ($container->privates['contao.security.data_container.page_type_access_voter'] ?? $container->load('getContao_Security_DataContainer_PageTypeAccessVoterService'));
            yield 17 => ($container->privates['contao.security.data_container.undo_voter'] ?? $container->load('getContao_Security_DataContainer_UndoVoterService'));
            yield 18 => ($container->privates['contao.security.data_container.user_access_voter'] ?? $container->load('getContao_Security_DataContainer_UserAccessVoterService'));
            yield 19 => ($container->privates['contao.security.member_group_voter'] ??= new \Contao\CoreBundle\Security\Voter\MemberGroupVoter());
            yield 20 => ($container->privates['contao_faq.security.faq_access_voter'] ?? $container->load('getContaoFaq_Security_FaqAccessVoterService'));
            yield 21 => ($container->privates['contao_faq.security.faq_category_access_voter'] ?? $container->load('getContaoFaq_Security_FaqCategoryAccessVoterService'));
            yield 22 => ($container->privates['contao_news.security.news_access_voter'] ?? $container->load('getContaoNews_Security_NewsAccessVoterService'));
            yield 23 => ($container->privates['contao_news.security.news_archive_access_voter'] ?? $container->load('getContaoNews_Security_NewsArchiveAccessVoterService'));
            yield 24 => ($container->privates['contao_calendar.security.calendar_access_voter'] ?? $container->load('getContaoCalendar_Security_CalendarAccessVoterService'));
            yield 25 => ($container->privates['contao_calendar.security.calendar_events_access_voter'] ?? $container->load('getContaoCalendar_Security_CalendarEventsAccessVoterService'));
            yield 26 => ($container->privates['contao_newsletter.security.newsletter_access_voter'] ?? $container->load('getContaoNewsletter_Security_NewsletterAccessVoterService'));
            yield 27 => ($container->privates['contao_newsletter.security.newsletter_channel_access_voter'] ?? $container->load('getContaoNewsletter_Security_NewsletterChannelAccessVoterService'));
            yield 28 => ($container->privates['contao_newsletter.security.newsletter_recipients_access_voter'] ?? $container->load('getContaoNewsletter_Security_NewsletterRecipientsAccessVoterService'));
            yield 29 => ($container->privates['contao.security.default_data_container_voter'] ??= new \Contao\CoreBundle\Security\Voter\DataContainer\DefaultDataContainerVoter());
        }, 30), new \Contao\CoreBundle\Security\Authentication\ContaoStrategy(new \Symfony\Component\Security\Core\Authorization\Strategy\AffirmativeStrategy(false), new \Symfony\Component\Security\Core\Authorization\Strategy\PriorityStrategy(), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), $a));
    }
