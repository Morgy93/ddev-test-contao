...
class getContao_Listener_InsertTags_TranslationService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['contao.listener.insert_tags.translation'] = new \Contao\CoreBundle\EventListener\InsertTags\TranslationListener(($container->services['translator'] ?? self::getTranslatorService($container)));
    }
}
