...
class getContaoManager_Listener_BackendMenuService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['contao_manager.listener.backend_menu'] = new \Contao\ManagerBundle\EventListener\BackendMenuListener($a, $b, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->services['translator'] ?? self::getTranslatorService($container)), false, NULL, ($container->services['contao_manager.jwt_manager'] ?? $container->get('contao_manager.jwt_manager', 3)));
    }
}
