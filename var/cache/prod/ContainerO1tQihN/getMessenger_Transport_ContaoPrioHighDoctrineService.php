 ...
 */
class getMessenger_Transport_ContaoPrioHighDoctrineService extends Contao_ManagerBundle_HttpKernel_ContaoKernelProdContainer
{
    /*
     * Gets the private 'messenger.transport.contao_prio_high_doctrine' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['messenger.transport.contao_prio_high_doctrine'])) {
            return $container->privates['messenger.transport.contao_prio_high_doctrine'];
        }

        return $container->privates['messenger.transport.contao_prio_high_doctrine'] = $a->createTransport('doctrine://default?table_name=tl_message_queue&queue_name=prio_high&auto_setup=false', ['transport_name' => 'contao_prio_high_doctrine'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
